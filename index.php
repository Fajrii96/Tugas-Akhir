...
/*					$fire_strength = array();
          ...
          elseif($rowcount2 == 5){
            ...
            {$newliskrit[5]} varchar(20) NOT NULL,
            {$newliskrit[6]} varchar(20) NOT NULL,
            {$newliskrit[7]} varchar(20) NOT NULL,
            fire_strength float(20) NOT NULL,
            PRIMARY KEY ( id )
            )");
            //create penghitungan_bobot_tb untuk menampung bobot2 rekomendasi
            ...
            {$newliskrit[5]} float(20) NOT NULL,
            {$newliskrit[6]} float(20) NOT NULL,
            {$newliskrit[7]} float(20) NOT NULL,
            fire_strength float(20) NOT NULL,
            PRIMARY KEY ( id )
            )");
          }elseif($rowcount2 == 9){
            ...
            {$newliskrit[6]} varchar(20) NOT NULL,
            {$newliskrit[7]} varchar(20) NOT NULL,
            {$newliskrit[8]} varchar(20) NOT NULL,
            fire_strength float(20) NOT NULL,
            PRIMARY KEY ( id )
            )");
            //create penghitungan_bobot_tb untuk menampung bobot2 rekomendasi
            ...
            {$newliskrit[6]} float(20) NOT NULL,
            {$newliskrit[7]} float(20) NOT NULL,
            {$newliskrit[8]} float(20) NOT NULL,
            fire_strength float(20) NOT NULL,
            PRIMARY KEY ( id )
            )");
          }elseif($rowcount2 == 10){
            ...
            {$newliskrit[7]} varchar(20) NOT NULL,
            {$newliskrit[8]} varchar(20) NOT NULL,
            {$newliskrit[9]} varchar(20) NOT NULL,
            fire_strength float(20) NOT NULL,
            PRIMARY KEY ( id )
            )");
            //create penghitungan_bobot_tb untuk menampung bobot2 rekomendasi
            ...
            {$newliskrit[7]} float(20) NOT NULL,
            {$newliskrit[8]} float(20) NOT NULL,
            {$newliskrit[9]} float(20) NOT NULL,
            fire_strength float(20) NOT NULL,
            PRIMARY KEY ( id )
            )");
          }
           ...
           endwhile;
              ...
              $inwis = $idx -1;
                ...
                if($rowcount2==1){
                  ...
                  mysqli_query($conn, "INSERT INTO rekomendasi_tb(obyek_wisata, {$newliskrit[0]}, {$newliskrit[1]},{$newliskrit[2]}, {$newliskrit[3]},{$newliskrit[4]}, {$newliskrit[5]},{$newliskrit[6]}, fire_strength) 
                  VALUES('$ob_wis', '$krit1', '$krit2', '$krit3', '$krit4','$krit5','$krit6','$krit7','$fs')");
